                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; <a href="https://vivirchevere.com" target="_blank" rel="noopener noreferrer">Visite mi pagina web</a> <?php echo date("Y"); ?></div>
                            <div>
...
<!-- psql -U david -d D:\DOCUMENTOS\Documents\David\Programacion\Bases de datos -f francisco5.sql -->
